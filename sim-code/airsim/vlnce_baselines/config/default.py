...
# -----------------------------------------------------------------------------
_C.MAP = CN()
_C.MAP.GROUNDING_DINO_CONFIG_PATH = "path/to/TravelUAV/data/grounded_sam/GroundingDINO_SwinT_OGC.py"
_C.MAP.GROUNDING_DINO_CHECKPOINT_PATH = "path/to/TravelUAV/data/grounded_sam/groundingdino_swint_ogc.pth"
_C.MAP.SAM_CHECKPOINT_PATH = "path/to/TravelUAV/data/grounded_sam/sam_vit_h_4b8939.pth"
