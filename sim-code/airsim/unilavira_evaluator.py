...
from src.model_wrapper.unilavira_model import ZeroShotVlnEvaluatorMP
from src.model_wrapper.base_model import BaseModelWrapper
from src.common.param import args, model_args, data_args, data_habitat
    ...
    with torch.no_grad():
        ...
        while True:
            ...
            if env_batchs is None:
                break
            batch_state = EvalBatchState(batch_size=eval_env.batch_size, env_batchs=env_batchs, env=eval_env, assist=assist, model_wrapper=model_wrapper)
            ...
            for t in range(int(args.maxWaypoints) + 1):
                print("======================================================Starting navigation policy======================================================")
...
if __name__ == "__main__":
    ...
    model_wrapper = ZeroShotVlnEvaluatorMP(model_args=model_args, data_args=data_args, data_habitat=data_habitat)
